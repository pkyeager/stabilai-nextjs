  ...
  return (
    <div>
      ...
      <p>
        ...
        Information about the responsible party in this data protection
        declaration.
      </p>
      ...
      <p>
        Our hoster will only process your data to the extent necessary to fulfil
      ...
      <p>
        ...
        duration of any contractual relationship. For data that is not collected
        in the context of a contractual relationship (e.g. contact form
        inquiries), this data will be deleted after the purpose has been
        fulfilled.
      </p>
      ...
      <p>
        ...
        protection law. If these tools are active, your personal personal data
        may be transferred to these third countries and processed there. We
        would like to point out that no level of data protection comparable to
        that in the EU can be guaranteed in these countries. For example, US
        companies are obligated to release personal data to security authorities
        without your without you as the data subject being able to take legal
        action against this. It can therefore not be authorities (e.g.,
        intelligence services) may process, evaluate and use your data stored on
        U.S. servers for surveillance purposes. monitoring purposes, evaluate
        and permanently store it. We have no influence on these have any
      ...
      <p>
        ...
        E OR F OF THE GDPR YOU HAVE THE RIGHT TO OBJECT AT ANY TIME, ON GROUNDS
        RELATING TO YOUR PARTICULAR SITUATION, TO OBJECT TO THE PROCESSING OF
        YOUR PERSONAL DATA; THIS ALSO APPLIES TO THIS ALSO APPLIES TO A
        PROFILING BASED ON THESE PROVISIONS. PROFILING. THE RESPECTIVE LEGAL
        BASIS ON WHICH PROCESSING IS BASED, PLEASE REFER TO THIS PRIVACY POLICY.
        ...
        WHICH OUTWEIGH YOUR INTERESTS, RIGHTS AND FREEDOMS, OR THE PROCESSING
        SERVES THE ASSERTION PROCESSING IS FOR THE PURPOSE OF ASSERTING,
        EXERCISING OR DEFENDING LEGAL CLAIMS (OBJECTION ACCORDING TO ART. 21
        PARA. 1 DSGVO). IF YOUR PERSONAL DATA IS PROCESSED FOR THE PURPOSE OF
      ...
      <p>
        ...
        personal data, its origin and recipients and the purpose of the data
        processing and, if applicable, a right to correct or delete this data.
        For further information on personal data, please contact us at any time
      ...
      <p>
        ...
        the legal notice. The right to restriction of processing exists in the
        following cases:
      </p>
      ...
      <p>
        If the processing of your personal data happened / happens unlawfully,
        you can request the restriction of the data processing instead of
        deletion.
      </p>
      ...
      <p>
        If you have lodged an objection pursuant to Art. 21 (1) DSGVO, a balance
      ...
      <p>
        ...
        apart from being stored may only be processed with your consent or for
        the purpose of asserting, exercising or defending legal claims or
        protecting the rights of another natural or legal person or for reasons
      ...
      <p>
        ...
        sufficient. The data processed before we receive your request may still
      ...
      <p>
        ...
        via your IP address. The use of Google Web fonts is done in the interest
